...
* Lets teacher create homeork and assign it (not requied as per bried but still completed)
...
Note : You have to add the users from the seed or using the "rails c" command. If 
...
* Deployment instructions - coming soon. (need to aqquire a server and set it up)
