...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { duedate: @homework.duedate, question: @homework.question, title: @homework.title }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { duedate: @homework.duedate, question: @homework.question, title: @homework.title }
    assert_redirected_to homework_path(assigns(:homework))
  end
